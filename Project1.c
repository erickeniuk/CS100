...
int main(void) {
  ...
  printf("Let's calculate the volume of money you have!\n");
  ...
  coinvolume = ((3.14159 * 1.213 * 1.213 * .175) * quarters)
  + ((3.14159 * .8955 * .8955 * .135) * dimes)
  + ((3.14159 * 1.0605 * 1.0605 * .195) * nickels)
